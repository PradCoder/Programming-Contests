 ...
 * its behaviour is undefined on negative numbers
 *
 */
int mod(int n, int m){
    while(n<0) n+=m;
...
/**
 * Calculate number of beads gotten by breaking before character
 * p and going in direction dir, which is 1 for forward and -1 for 
 * backward.
 */
